...
The latest release, **0.7.20 is [available here](http://draeton.github.com/tanchor/tanchor/dist/tanchor-0.7.20.zip).**
...
<script>
Modernizr.load({
    load: "/tanchor/tanchor/build/js/tanchor-0.7.20-min.js",
    complete: function () {
    }
});
</script>