...
The latest release, **0.7.21 is [available here](http://draeton.github.com/tanchor/tanchor/dist/tanchor-0.7.21.zip).**
...
<script>
Modernizr.load({
    load: "/tanchor/tanchor/build/js/tanchor-0.7.21-min.js",
    complete: function () {
    }
});
</script>