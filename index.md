...
The latest release, **0.7.17 is [available here](http://draeton.github.com/tanchor/tanchor/dist/tanchor-0.7.17.zip).**
...
<script>
Modernizr.load({
    load: "/tanchor/tanchor/build/js/tanchor-0.7.17-min.js",
    complete: function () {
    }
});
</script>